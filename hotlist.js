var json = {
    "code": "var yes = round(random(1));\n//{\nstrokeJoin(ROUND);\nbackground(143, 202, 227);\nstroke(200);\nstrokeWeight(10);\nnoFill();\nbeginShape();\n   vertex(52,199);\n   bezierVertex(52,199,35,158,49,121);\n   bezierVertex(54,107,54,107,66,139);\n   bezierVertex(76,155,76,155,84,115);\n   bezierVertex(92,107,92,107,104,191);\nendShape();\nbeginShape();\n   vertex(172,179);\n   bezierVertex(172,179,135,182,131,182);\n   bezierVertex(125,182,125,182,128,108);\n   bezierVertex(128,104,127,104,175,102);\nendShape();\nbeginShape();\n   vertex(120,140);\n   bezierVertex(120,140,144,139,163,136);\nendShape();\nbeginShape();\n   vertex(220,108);\n   bezierVertex(220,108,221,132,218,185);\n   bezierVertex(232,193,248,186,271,186);\nendShape();\nbeginShape();\n   vertex(299,204);\n   bezierVertex(299,204,303,164,299,115);\nendShape();\nbeginShape();\n   vertex(347,118);\n   bezierVertex(347,118,324,147,296,160);\n   bezierVertex(313,166,321,176,342,188);\nendShape();\nstroke(61, 10, 10);\nstrokeWeight(3);\n//melk\nfill(255);\nbeginShape();\n   vertex(261,365);\n   bezierVertex(261,365,265,369,269,363);\n   bezierVertex(272,363,273,363,283,366);\n   bezierVertex(284,366,287,364,290,363);\n   bezierVertex(296,364,296,364,297,364);\n   bezierVertex(296,377,295,388,291,399);\n   bezierVertex(280,397,265,395,259,393);\n   bezierVertex(258,387,258,378,260,368);\nendShape();\nnoFill();\nbeginShape();\n   vertex(257,394);\n   bezierVertex(257,394,259,383,261,361);\n   bezierVertex(263,355,263,349,265,347);\n   bezierVertex(272,348,292,353,296,354);\n   bezierVertex(298,355,300,360,298,365);\n   bezierVertex(295,377,295,389,291,398);\n   bezierVertex(288,400,288,400,260,396);\nendShape();\nvar melk = get();\n//}melk\n//{\nstrokeJoin(ROUND);\nbackground(143, 202, 227);\nstroke(200);\nstrokeWeight(10);\nbeginShape();\n   vertex(49,185);\n   bezierVertex(49,185,48,140,45,79);\n   bezierVertex(43,77,43,77,100,76);\nendShape();\nbeginShape();\n   vertex(40,126);\n   bezierVertex(40,126,64,127,86,119);\nendShape();\nbeginShape();\n   vertex(150,46);\n   bezierVertex(150,46,189,55,190,116);\n   bezierVertex(184,149,163,158,148,122);\n   bezierVertex(145,91,148,72,164,71);\nendShape();\nbeginShape();\n   vertex(210,151);\n   bezierVertex(210,151,220,110,220,71);\n   bezierVertex(230,92,249,140,256,124);\n   bezierVertex(260,107,267,70,264,52);\nendShape();\nbeginShape();\n   vertex(332,56);\n   bezierVertex(332,56,304,62,277,59);\n   bezierVertex(285,86,282,109,275,145);\n   bezierVertex(278,154,277,154,335,143);\nendShape();\nbeginShape();\n   vertex(277,102);\n   bezierVertex(277,102,304,102,336,96);\nendShape();\nnoFill();\nstroke(0, 0, 0);\nstrokeWeight(3);\n//fone\nfill(255);\nbeginShape();\n   vertex(257,394);\n   bezierVertex(257,394,259,383,261,361);\n   bezierVertex(263,355,263,349,265,347);\n   bezierVertex(272,348,292,353,296,354);\n   bezierVertex(298,355,300,360,298,365);\n   bezierVertex(295,377,295,389,291,398);\n   bezierVertex(288,400,288,400,260,396);\nendShape();\npoint(269,358);\nstrokeWeight(10);\npoint(278,372);\nstrokeWeight(3);\nvar fone = get();\n//}fone\nbackground(0,0);\n//him\nfill(197, 235, 217);\nbeginShape();\n   vertex(140,500);\n   bezierVertex(140,498,136,495,137,487);\n   bezierVertex(137,483,141,478,172,450);\n   bezierVertex(193,444,205,439,199,417);\n   bezierVertex(192,394,179,361,179,354);\n   bezierVertex(180,349,174,338,171,322);\n   bezierVertex(190,320,190,320,190,320);\n   bezierVertex(192,331,194,349,196,353);\n   bezierVertex(197,354,198,361,202,393);\n   bezierVertex(212,428,231,450,243,457);\n   bezierVertex(256,466,260,466,264,467);\n   bezierVertex(264,470,264,473,264,474);\n   bezierVertex(264,474,266,460,267,446);\n   bezierVertex(267,439,267,430,266,422);\n   bezierVertex(273,425,273,425,273,424);\n   bezierVertex(263,420,258,421,254,419);\n   bezierVertex(254,410,255,403,253,401);\n   bezierVertex(253,394,255,393,260,393);\n   bezierVertex(269,396,279,398,288,398);\n   bezierVertex(294,398,295,399,292,411);\n   bezierVertex(291,422,287,429,286,434);\n   bezierVertex(286,448,281,459,278,466);\n   bezierVertex(278,475,275,486,275,491);\n   bezierVertex(272,494,272,494,264,488);\n   bezierVertex(257,484,252,476,243,468);\n   bezierVertex(222,460,202,460,183,461);\n   bezierVertex(173,467,164,478,157,488);\n   bezierVertex(158,489,158,489,158,488);\n   bezierVertex(162,495,164,498,164,500);\nendShape();\nbeginShape();\n   vertex(177,276);\n   bezierVertex(177,276,153,277,136,270);\n   bezierVertex(121,264,110,252,108,245);\n   bezierVertex(108,239,108,233,127,222);\n   bezierVertex(146,213,188,211,223,225);\n   bezierVertex(243,231,256,248,252,254);\n   bezierVertex(250,265,240,276,232,276);\n   bezierVertex(224,276,219,276,211,276);\n   bezierVertex(204,279,200,287,196,298);\n   bezierVertex(196,305,196,305,203,306);\n   bezierVertex(213,308,226,309,229,314);\n   bezierVertex(236,318,240,325,233,325);\n   bezierVertex(225,326,211,324,202,323);\n   bezierVertex(191,326,166,326,155,323);\n   bezierVertex(147,322,131,321,133,317);\n   bezierVertex(130,316,133,308,158,298);\n   bezierVertex(169,294,178,291,178,280);\nendShape();\nbeginShape();\n   vertex(180,270);\n   bezierVertex(180,270,171,274,168,277);\n   bezierVertex(164,280,164,281,162,292);\n   bezierVertex(159,303,164,307,168,310);\n   bezierVertex(177,313,179,311,180,305);\n   bezierVertex(184,300,187,292,187,281);\nendShape();\nbeginShape();\n   vertex(160,316);\n   bezierVertex(160,316,174,318,184,318);\n   bezierVertex(185,316,194,318,201,318);\nendShape();\n//hims close\nfill(166, 120, 63);\nbeginShape();\n   vertex(197,416);\n   bezierVertex(197,416,185,420,186,425);\n   bezierVertex(184,431,184,435,190,438);\n   bezierVertex(187,437,187,437,187,437);\n   bezierVertex(186,438,175,448,163,452);\n   bezierVertex(166,457,173,465,174,470);\n   bezierVertex(177,467,188,462,200,454);\nendShape();\nbeginShape();\n   vertex(172,498);\n   bezierVertex(172,498,176,461,193,434);\n   bezierVertex(195,432,196,430,200,428);\n   bezierVertex(196,414,187,404,182,394);\n   bezierVertex(186,394,192,394,204,391);\n   bezierVertex(205,399,208,406,215,420);\n   bezierVertex(222,427,231,431,240,435);\n   bezierVertex(245,438,253,446,256,454);\n   bezierVertex(257,459,254,459,252,461);\n   bezierVertex(249,457,245,457,248,455);\n   bezierVertex(243,458,241,462,240,466);\n   bezierVertex(240,466,241,468,244,470);\n   bezierVertex(243,475,243,475,237,476);\n   bezierVertex(236,471,228,463,216,451);\n   bezierVertex(221,459,229,464,231,466);\n   bezierVertex(229,472,227,478,229,497);\nendShape();\nbeginShape();\n   vertex(203,439);\n   bezierVertex(203,439,204,434,200,428);\n   bezierVertex(206,426,216,421,216,414);\n   bezierVertex(216,411,216,411,219,410);\n   bezierVertex(223,411,226,415,227,426);\n   bezierVertex(227,430,227,430,224,433);\n   bezierVertex(220,435,216,437,212,443);\n   bezierVertex(213,435,211,430,208,432);\n   bezierVertex(207,437,207,437,203,438);\nendShape();\n//hims I bals\nstrokeWeight(7);\npoint(125,246);\npoint(205,250);\nvar skwidwerd = get();\nswitch(yes){\n    case 0:\n        image(melk,0,0);\n    break;\n    case 1:\n        image(fone,0,0);\n    break;\n}\nimage(skwidwerd,0,0);\nnoStroke();\nfor(var i = 0; i < 250; i ++){\nfor(var j = 0; j < 200; j ++){\n    fill(205,random(50));\n    rect(j*2,i*2,2,2);\n}\n}\nenableContextMenu();\nrandom();",
    "title": "melk",
    "votes": 52,
    "created": "a day ago",
    ...
    "forks": [
        ...
        },
        {
            ...
            "author": {
                "name": "Davey Ward",
                "id": "kaid_6486106684221018736997635"
            }
        }
    ],
    "posts": {
        "tips": [
            {
                ...
                "text": "https://www.khanacademy.org/computer-programming/nlhub/4837917417586688<br><br>sub?<br><br>i wont give u any notifs. i dont make stuff",
                "locked": false,
                "pinned": false,
                "replies": []
            },
            ...
            },
            {
                ...
                "text": "Why? X'D<br><br>I've never watched the show, but even I know who \"he\" is. :/",
                "locked": false,
                "pinned": false,
                "replies": []
            },
            ...
            },
            {
                ...
                "text": "You can right click to save this picture lol",
                "locked": false,
                "pinned": false,
                "replies": []
            },
            ...
            },
            {
                ...
                "text": "Welp, this graphic sums up the state the of hotlist. :/",
                "locked": false,
                "pinned": false,
                "replies": []
            }
